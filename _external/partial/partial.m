...
- (NSError*)_getMetadata {
    ...
    // Note: We intentionally skip the Accept-Ranges header check here.
    // Some CDN servers (e.g. Apple's updates.cdn-apple.com) omit or vary this
    // header in HEAD responses even though they fully support Range requests.
    // Actual range support is validated later in _getBytesInRange via HTTP 206.
